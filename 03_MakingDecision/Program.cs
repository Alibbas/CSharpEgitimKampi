...
namespace _03_MakingDecision
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.Write("Şifreyi girer misiniz: ");
            //string password;
            ...
            //if (city == "adana" | city == "trabzon" | city == "bursa") 
            //{
            ...
            #region CharDeğişkenlerileKararYapıları
            ...
            switch (symbol)
            {
                ...
                default: Console.WriteLine("Yanlış karakter kullanımı"); break;
            }
            #endregion
